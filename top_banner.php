...
<header class="header-transparent">
  <div class="header-top header-top-row top-layout-02">
    <div class="container">
          ...
          <div class="item">
            <ul class="socials-nb list-inline wg-social">
              <li class="list-inline-item">
                <a href="https://www.facebook.com/profile.php?id=100094976265096" target="_blank">
  ...
  <div class="header-main">
    <div class="container">
      ...
      <div class="utility-nav"><!-- <div class="dropdown dropdown-full-mobile open"><a href="#" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="search-bar dropdown-toggle"><i class="fa fa-shopping-bag"></i></a>
      ...
      <nav id="main-nav-offcanvas" class="main-nav-wrapper">
        ...
        <div class="main-nav">
          <ul id="main-nav" class="nav nav-pills">
            <li class="nav-item dropdown dropdown--hover current-menu-item">
              <a href="index.php" class="dropdown-item">Home</a>
              <!-- <a href="index.php" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Home</a> -->
            ...
            <li class="nav-item dropdown dropdown--hover">
              <a href="blogs.php" class="dropdown-item">Blog</a>
            ...
            <li class="nav-item">
              <a href="assets/docs/Rococo-Venue-Presentation.pdf" target="_blank" class="nav-link">Venue</a>
            </li>
            <li class="nav-item">
              <a href="contact.php" class="nav-link">Contacts</a>
            </li>
            <li class="nav-item">
              <a href="assets/docs/Rococo-Brochure.pdf" target="_blank" class="nav-link">Brochure</a>
            </li>
          </ul>
        </div>
      </nav>
