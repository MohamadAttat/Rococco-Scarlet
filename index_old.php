                        ...
                        <div class="swin-sc swin-sc-testimonial style-1">
                          ...
                          <div data-width="150" class="nav-slider">
                            <ul class="slides list-inline">
                              <li class="list-inline-item swin-transition"><a href="javascript:void(0)" class="testimonial-nav-item"><img src="assets/images/testi/testi-1.jpg" alt="fooday" class="img img-responsive swin-transition"></a></li>
                              <li class="list-inline-item swin-transition"><a href="javascript:void(0)" class="testimonial-nav-item"><img src="assets/images/testi/testi-2.jpg" alt="fooday" class="img img-responsive swin-transition"></a></li>
                              <li class="list-inline-item swin-transition"><a href="javascript:void(0)" class="testimonial-nav-item"><img src="assets/images/testi/testi-3.jpg" alt="fooday" class="img img-responsive swin-transition"></a></li>
                              <li class="list-inline-item swin-transition"><a href="javascript:void(0)" class="testimonial-nav-item"><img src="assets/images/testi/testi-4.jpg" alt="fooday" class="img img-responsive swin-transition"></a></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="form-dark-wrapper">
                      ...
                      <div class="swin-sc swin-sc-contact-form dark mtl">
                        <form action="#" method="POST">
                          ...
                          <div class="form-group">
                            <div class="swin-btn-wrap center"><button type="submit" class="swin-btn link-underline link-underline-opacity-0 center form-submit"> <span>	Find Table</span></button></div>
