...
$(document).ready(function () {
                    ...
                    featuredBlogsHtml += `
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div data-wow-delay="${delay}s" class="blog-item swin-transition item wow fadeInUpShort">
                                ...
                                <a href="blog-single.php?id=${blog.id}" target="_blank">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h3 class="blog-title">
                                        <a href="blog-single.php?id=${blog.id}" target="_blank" class="link-underline link-underline-opacity-0 swin-transition">${blog.title}</a>
                                    </h3>
                                    <p class="blog-description">${truncateText(blog.description, 100)}</p>
                                    <div class="blog-readmore">
                                        <a href="blog-single.php?id=${blog.id}" target="_blank" class="link-underline link-underline-opacity-0 swin-transition">Read More <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>`;
    ...
    $('#btn_book_table').on('click', function (e) {
            ...
            // Collect form data
            const formData = {
                username: $('input[placeholder="FullName"]').val(),
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                    $('input[placeholder="FullName"]').val(""),
    ...
    $('#btn_contact_submit').on('click', function (e) {
            ...
            const contactData = {
                action: 'send_message',
                username: $('input[placeholder="FullName"]').val().trim(),
                                ...
                                <div class="main-slider">
                                    <div class="slides">
                                        <div class="blog-item swin-transition">
                                            ...
                                            <div class="blog-content">
                                                <div class="blog-date"><span class="day">${day}</span><span class="month">${month}</span></div>
                                                <h3 class="blog-title"><a href="blog-single.php?id=${blog.id}" target="_blank" class="link-underline link-underline-opacity-0 swin-transition">${blog.title}</a></h3>
                                                <p class="blog-description">${truncateText(blog.description, 100)}</p>
                                                <div class="blog-readmore"><a href="blog-single.php?id=${blog.id}" target="_blank" class="link-underline link-underline-opacity-0 swin-transition">Read More <i class="fa fa-angle-double-right"></i></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
