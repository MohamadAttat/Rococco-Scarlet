...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="rococo_images/r_icon.png">
  ...
  <!-- IE 9-->
  <!-- Vendors-->
  <link rel="stylesheet" href="assets/vendors/flexslider/flexslider.min.css"> <link rel="stylesheet" href="assets/vendors/swipebox/css/swipebox.min.css">
  ...
  <link
  rel="stylesheet" href="assets/vendors/dialog/css/dialog.css">
  <!-- Font-icon-->
  <link
  rel="stylesheet" href="assets/fonts/font-icon/style.css">
  <!-- Style-->
  ...
  <link
  rel="stylesheet" type="text/css" href="assets/css/site-responsive.css">
  <!-- Google Font-->
  <link href="https://fonts.googleapis.com/css?family=Merriweather+Sans:400,700,700i" rel="stylesheet">
  <link
  href="https://fonts.googleapis.com/css?family=Rancho" rel="stylesheet">
  <!-- Script Loading Page-->
...
})(window, document, 'script', 'dataLayer', 'GTM-PSMZKGLL');
  </script>
