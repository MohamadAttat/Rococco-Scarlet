     ...
     <div class="container">
       ...
       <div class="topbar-right">
         <div class="topbar-content">
           ...
           <div class="item">
             <div class="wg-social"><i class="fa fa-user"></i><a href="javascript:void(0)" class="link-underline link-underline-opacity-0">My Account</a></div>
           </div>
         </div>
       </div>
     </div>
       ...
       <nav id="main-nav-offcanvas" class="main-nav-wrapper">
         ...
         <div class="main-nav">
           <ul id="main-nav" class="nav nav-pills">
             <li class="nav-item dropdown dropdown--hover"><a href="index.html" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Home</a><i class="fa fa-angle-down btn-open-dropdown"></i>
               <ul class="dropdown-menu">
                 ...
                 <li><a href="homesidebarmenu.html" target="_blank" class="dropdown-item">Home Sidebar Menu</a></li>
             ...
             <li class="nav-item current-menu-item"><a href="about.html" class="nav-link">About</a></li>
             <li class="nav-item"><a href="reservation.html" class="nav-link">Reservation</a></li>
             <li class="nav-item dropdown dropdown--hover"><a href="menu-grid-1.html" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">
