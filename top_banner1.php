     ...
     <header >
          ...
          <div class="header-main">
            <div class="container">
              ...
              <div class="header-logo"><a href="index.html" class="logo logo-static">
                <img src="assets/images/custom/rococo_logo.jpg" alt="ROCOCO" class="logo-img">
              </a><a href="index.html" class="logo logo-fixed">
                <img src="assets/images/custom/rococo_logo.jpg" alt="ROCOCO" class="logo-img">
              ...
              <nav id="main-nav-offcanvas" class="main-nav-wrapper">
                ...
                <div class="main-nav">
                  <ul id="main-nav" class="nav nav-pills">
                    ...
                    <a href="menu_functional.php" class="dropdown-item">Menu </a>
                    ...
                    <li class="nav-item dropdown dropdown--hover">
                    <a href="blogs.html" class="dropdown-item">Blog</a>
